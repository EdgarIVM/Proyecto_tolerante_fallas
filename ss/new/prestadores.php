				...
				<!-- Header -->
					<header id="header">
						<div class="inner">
                            ...
                            <a href="http://localhost/SS/new/admin.php">
                            <img class="img2" src="http://localhost/SS/images/admin.png" alt="" >
                            </a>
       ...
       $password = "";
        ...
        $db = new mysqli($hostname,$username,$password,$database);
                                            ...
                                            <tr>
                                                ...
                                                <td><center><input type="submit" class="prestador" id="<?php echo $row["codigo"]; echo $row["nombre"]; ?>" value="Eliminar"></center></td>
                                            </tr>
                                            <?php   
		...
		<!-- Scripts -->
			...
			<script src="http://localhost/SS/assets/js/acciones.js"></script>
