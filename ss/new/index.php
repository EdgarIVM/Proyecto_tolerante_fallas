	...
	<body>
       ...
       /* $token = obtenerSessionToken();
		...
		<!-- Wrapper -->
			...
			<div id="wrapper">
                ...
                <!-- Login box -->                    
                                        ...
                                        <img onclick="document.getElementById('id01').style.display='block'" class="img2" src="http://localhost/SS/images/admin.png" alt="" >
                            ...
                            <div id="id01" class="modal">
                                ...
                                <form class="modal-content animate" method="post" action="http://localhost/SS/new/validar_admin2.php">
					...
					<div id="main">
						<div class="inner">
                            ...
                            <div class="tabla_activos">
                                <table class="activos">
                                    <tr>
                                            <th class= "hours_table"><center>PRESTADORES EN JORNADA</center></th>
                                            <th class = "hours_table"><center>HORAS DEL DÍA</center></th>
                                        </tr>
        ...
        $db = new mysqli($hostname,$username,$password,$database);
                        ...
                        <div class="list">
                            ...
                            <table class="steps">
                                <tr>
                                    <td>Paso 1<td>
                                    <td>Para comenzar a registrar horas debes pedir al titular de la dependencia crearte un usuario.<td>
                                </tr>
                                <tr>
                                    <td>Paso 2<td>
                                    <td>Una vez creado el usario, debes  ingresar tu código SIIAU en el "<i>textbox</i>" y dar click en CHECK IN.<td>
                                </tr>
                                <tr>
                                    <td>Paso 3<td>
                                    <td>Inicia tu jornada de servicio social.<td>
                                </tr>
                                <tr>
                                    <td>Paso 4<td>
                                    <td>Al finalizar tu jornada, vuelve a poner tu código SIIAU y da click en CHECK OUT.<td>
                                </tr>
                            </table>
                            </div>
						</div>
		...
		<!-- Scripts -->
            ...
            <script src="http://localhost/SS/assets/js/jquery-3.1.1.js"></script>
        <!-- First time slider -->
