...
<body>
    ...
    ?><script type="text/javascript">
                    alert("Código SIIAU repetido");
                            ...
                            ?><script type="text/javascript">
                        alert("Error, registrar de nuevo");
                    </script><?php
                            }
                        }
                    }
        ...
        <div id="main">
            <div class="inner">
                ...
                <div class="acciones1">
                    ...
                    <table class="admin">
                        <tr>
                            <td onclick="location.href='reporte_general.php'">Reporte general
                            <td>
                        </tr>

                        <tr>

                            <td onclick="location.href='prestadores.php'">Prestadores
                            <td>

                        </tr>

                        <tr>
                            <td onclick="location.href='ultimos_registros.php'">Últimos registros
                            <td>
                        </tr>
                    </table>
